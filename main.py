...
from CustomerReviewClassification.pipeline.prediction_pipeline import PredictionPipeline
...
if __name__ == "__main__":
    try:
        ...
        text = "It can't be used; it doesn't work, it's very bad."
        prediction_pipeline = PredictionPipeline(model_name="LogisticRegression")
        prediction = prediction_pipeline.initiate_model_prediction(review_text=text)
        print(prediction)
